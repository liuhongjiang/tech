...
{% include_code 析构函数为虚函数 lang:cpp cpp/destructor_virtual.cc %}

运行结果

{% img center /images/blogimages/destructor_virtual.jpg %}
...
{% include_code  诡异的同名函数 lang:cpp cpp/same_name.cc %}

输出结果

{% img center /images/blogimages/same_name.jpg %}
...
{% include_code  诡异的同名函数 lang:cpp cpp/same_name1.cc %}

在编译的时候会报这样的错误

{% img center /images/blogimages/same_name1_error.jpg %}
